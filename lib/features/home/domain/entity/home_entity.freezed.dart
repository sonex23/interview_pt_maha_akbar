...
class _$HomeEntityImpl implements _HomeEntity {
  ...
  @override
  String toString() {
    return 'HomeEntity(page: $page, perPage: $perPage, total: $total, totalPages: $totalPages, data: $data, support: $support)';
  }
...
abstract class _HomeEntity implements HomeEntity {
  const factory _HomeEntity(
      ...
      @JsonKey(name: "data") final List<Datum>? data,
      @JsonKey(name: "support") final Support? support}) = _$HomeEntityImpl;
...
abstract class _Datum implements Datum {
  const factory _Datum(
      ...
      @JsonKey(name: "avatar") final String? avatar}) = _$DatumImpl;
...
class _$SupportImpl implements _Support {
  const _$SupportImpl(
      {@JsonKey(name: "url") this.url, @JsonKey(name: "text") this.text});
...
abstract class _Support implements Support {
  const factory _Support(
      ...
      @JsonKey(name: "text") final String? text}) = _$SupportImpl;
